...
function parseIndexerSettings(env: NodeJS.ProcessEnv): IndexerSettings {
  return {
    ...
    syncWindow: parsePositiveInteger(env.ONLYDOGE_INDEXER_SYNC_WINDOW, 64),
    ...
    projectWindow: parsePositiveInteger(env.ONLYDOGE_INDEXER_PROJECT_WINDOW, 32),
    projectTimeoutMs: parsePositiveInteger(env.ONLYDOGE_INDEXER_PROJECT_TIMEOUT_MS, 120_000),
    relinkBatchSize: parsePositiveInteger(env.ONLYDOGE_INDEXER_RELINK_BATCH_SIZE, 64),
    relinkConcurrency: parsePositiveInteger(env.ONLYDOGE_INDEXER_RELINK_CONCURRENCY, 4),
    relinkFrontierBatch: parsePositiveInteger(env.ONLYDOGE_INDEXER_RELINK_FRONTIER_BATCH, 128),
